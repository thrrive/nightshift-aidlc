...
```bash
codex plugin marketplace add thrrive/nightshift-aidlc --ref v1.0.0-rc.2
codex plugin add nightshift@nightshift-aidlc
```
...
For stable-v1 qualification, pin `v1.0.0-rc.2` exactly. Promotion to `v1.0.0` changes release
