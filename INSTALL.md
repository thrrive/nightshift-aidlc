...
```bash
codex plugin marketplace add thrrive/nightshift-aidlc --ref v1.0.0-rc.3
codex plugin add nightshift@nightshift-aidlc
```
...
For stable-v1 qualification, pin `v1.0.0-rc.3` exactly. Promotion to `v1.0.0` changes release
